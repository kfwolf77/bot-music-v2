...
const GUILDID = '462658139699937311'; // اي دي السيرفر  
const CHANNELID = '732214904546918450'; // اي دي الروم
...
client.on('ready', () => {
  console.log(`Logged in as ${client.user.tag}!`);
   client.user.setActivity("Bemo",{type: 'Listening'})
});
...
const youtube = new YouTube("AIzaSyDVOk1w5UDKOzXwIr0Sa7TkAieuld4mIpI");
